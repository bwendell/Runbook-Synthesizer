...
- [ ] 1. OCI Authentication Enhancements <!-- id: 1 -->
    - [ ] 1.1 Update `OciConfig` to handle environment variables <!-- id: 2 -->
    ...
    - [ ] 1.2 Implement prioritized auth detection in `OciAuthProviderFactory` <!-- id: 3 -->
    ...
    - [ ] 1.3 Add support for Instance and Resource Principals <!-- id: 4 -->
...
- [ ] 2. Oracle 23ai Container Integration <!-- id: 5 -->
    - [ ] 2.1 Add Testcontainers dependencies to `pom.xml` <!-- id: 6 -->
    ...
    - [ ] 2.2 Create `OracleContainerBase` test class <!-- id: 7 -->
    ...
    - [ ] 2.3 Create centralized schema initialization script for vector store <!-- id: 8 -->
    ...
    - [ ] 2.4 Add Ollama container with shared network support <!-- id: 15 -->
...
- [ ] 3. CI/CD Integration <!-- id: 9 -->
    - [ ] 3.1 Document environment variable requirements for CI secrets <!-- id: 10 -->
    ...
    - [ ] 3.2 Add Maven profile `ci-integration` for non-Docker cloud tests <!-- id: 11 -->
...
- [ ] 4. Verification <!-- id: 12 -->
    - [ ] 4.1 Migrate `VectorStoreIT` to use real Oracle 23ai container <!-- id: 13 -->
