...
class VectorStoreRepositoryTest {
	...
	private RunbookChunk createTestChunk(String id) {
		return new RunbookChunk(id, "runbooks/memory/high-memory.md", "Step 1: Check memory",
				"Run free -h to check memory", List.of("memory"), List.of("VM.*"), new float[768]);
	}

	/**
	 * Test implementation of VectorStoreRepository for verifying interface
	 * contract.
	 */
