 ...
 *
 * <p>Tests verify that metrics, logs, and resource metadata are correctly fetched and assembled
...
class ContextEnrichmentIT extends IntegrationTestBase {
  ...
  private Alert createTestAlert(String resourceId) {
    return new Alert(
        ...
        "oci-monitoring",
        Map.of("resourceId", resourceId, "compartmentId", "ocid1.compartment.oc1..example"),
  ...
  /**
   * Test implementation of ContextEnrichmentService that uses WireMock for external calls.
   *
   * <p>In a real implementation, this would use actual OCI SDK clients configured with the WireMock
   * base URL.
   */
