 ...
 *
 * <p>Tests store, retrieve, and search functionality using an in-memory implementation.
 */
class VectorStoreIT extends IntegrationTestBase {
  ...
  void storeBatch_ThenSearch_ReturnsTopKChunks() {
    ...
    List<RunbookChunk> chunks =
        List.of(
            ...
            createChunk(
                "chunk-mem-1", "Memory troubleshooting", new float[] {0.1f, 0.8f, 0.0f, 0.0f}),
            createChunk(
                "chunk-disk-1", "Disk troubleshooting", new float[] {0.0f, 0.1f, 0.8f, 0.0f}));
  ...
  private RunbookChunk createChunk(String id, String content, float[] embedding) {
    String runbookPath =
        id.startsWith("chunk-a") ? "runbooks/runbook-a.md" : "runbooks/runbook-b.md";
