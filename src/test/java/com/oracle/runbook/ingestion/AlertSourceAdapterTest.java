...
class AlertSourceAdapterTest {
	...
	private static class TestAlertSourceAdapter implements AlertSourceAdapter {
		...
		public Alert parseAlert(String rawPayload) {
			...
			return new Alert("alert-001", "High CPU", "CPU threshold exceeded", AlertSeverity.CRITICAL, sourceType,
					Map.of("resourceId", "ocid1.instance.oc1..example"), Map.of(), Instant.now(), rawPayload);
		}
