...
class OciLoggingAdapterTest {
	...
	void testImplementsLogSourceAdapter() {
		assertTrue(LogSourceAdapter.class.isAssignableFrom(OciLoggingAdapter.class),
	...
	void testFetchLogsContract() {
		try {
			var method = OciLoggingAdapter.class.getMethod("fetchLogs", String.class, java.time.Duration.class,
					String.class);
