...
/**
 * Port interface for retrieving relevant runbook chunks based on enriched
 * context.
 * <p>
 * This interface defines the contract for the RAG retrieval component.
 * Implementations combine vector similarity search with metadata filtering to
 * find the most relevant runbook sections for a given alert context.
 *
 * @see RetrievedChunk
 * @see EnrichedContext
 */
public interface RunbookRetriever {
	 ...
	 *
	 * @param context
	 *            the enriched alert context to search with
	 * @param topK
