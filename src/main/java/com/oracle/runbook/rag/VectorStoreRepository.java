...
public interface VectorStoreRepository {
   ...
   *
   * <p>The implementation should use vector similarity search (e.g., Oracle 23ai AI_VECTOR_SEARCH
   * functions) to find chunks with embeddings closest to the query.
   *
