 ...
 * <p>
 * This interface defines the contract for vector storage in the Hexagonal
 * Architecture. Implementations provide concrete integrations with vector
 * databases like Oracle Database 23ai with AI Vector Search.
 * <p>
...
public interface VectorStoreRepository {
	 ...
	 * <p>
	 * More efficient than calling {@link #store(RunbookChunk)} repeatedly during
	 * document ingestion.
	 *
	 * @param chunks
	 *            the list of runbook chunks to store
	 */
	 ...
	 * <p>
	 * The implementation should use vector similarity search (e.g., Oracle 23ai
	 * AI_VECTOR_SEARCH functions) to find chunks with embeddings closest to the
	 * query.
	 *
	 ...
	 * <p>
	 * Enables re-indexing when a runbook is updated - delete old chunks before
	 * storing new ones.
	 *
	 * @param runbookPath
	 *            the path of the runbook whose chunks should be deleted
	 */
