 ...
 *
 * <p>This interface defines the contract for the embedding service in the RAG pipeline. It acts as
 * a facade over {@link LlmProvider#generateEmbedding(String)}, separating the embedding concern
 * from text generation.
 *
 * <p>Implementations may add caching, normalization, or other optimizations. All methods are
 * non-blocking and return CompletableFuture.
 *
 * @see LlmProvider
 */
public interface EmbeddingService {
   ...
   *
   * <p>Used for query embedding during RAG retrieval.
   *
   ...
   *
   * <p>More efficient than calling {@link #embed(String)} repeatedly during document ingestion.
   *
   ...
   *
   * <p>Formats the alert and relevant metadata into a query string for embedding.
   *
