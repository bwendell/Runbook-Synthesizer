 ...
 * <p>
 * This interface defines the contract for the embedding service in the
 * RAG pipeline. It acts as a facade over {@link LlmProvider#generateEmbedding(String)},
 * separating the embedding concern from text generation.
 * <p>
 * Implementations may add caching, normalization, or other optimizations.
