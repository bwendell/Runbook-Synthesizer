 ...
 * <p>
 * This interface defines the contract for LLM backends in the Hexagonal
 * Architecture. Implementations provide concrete integrations with specific LLM
 * services like OCI Generative AI (Cohere), OpenAI, or Ollama.
 * <p>
 * All implementations must be non-blocking and return CompletableFuture to
 * support Helidon SE's reactive patterns. The interface supports both text
 * generation (for checklist synthesis) and embeddings (for RAG retrieval).
 *
...
public interface LlmProvider {
	 ...
	 * <p>
	 * This method is used for checklist synthesis, combining alert context and
	 * retrieved runbook chunks into troubleshooting instructions.
	 *
	 * @param prompt
	 *            the input prompt for text generation
	 * @param config
	 *            generation parameters (temperature, max tokens, model override)
	 ...
	 * <p>
	 * Used for query embedding during RAG retrieval to find similar runbook chunks
	 * in the vector store.
	 *
	 * @param text
	 *            the text to embed
	 ...
	 * <p>
	 * Used during document ingestion for efficient embedding of multiple runbook
	 * chunks. More efficient than calling {@link #generateEmbedding(String)}
	 * repeatedly.
	 *
	 * @param texts
