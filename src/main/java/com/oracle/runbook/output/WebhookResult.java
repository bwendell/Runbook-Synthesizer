 ...
 * <p>
 * Captures HTTP response details for logging, retry logic, and error handling.
 *
 * @param success
 ...
 */
public record WebhookResult(boolean success, int statusCode, String responseBody, Optional<String> errorMessage) {
	/**
