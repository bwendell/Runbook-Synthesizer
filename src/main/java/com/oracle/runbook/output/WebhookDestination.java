 ...
 * <p>
 * This interface defines the contract for webhook destinations in the
 * Hexagonal Architecture. Implementations provide concrete integrations
 * with specific platforms like Slack, PagerDuty, or custom HTTP endpoints.
 * <p>
...
public interface WebhookDestination {
     ...
     * <p>
     * Implementations should format the checklist appropriately for the
     * target platform (e.g., Slack Block Kit for Slack, PD Events API v2
     * for PagerDuty).
     *
     ...
     * <p>
     * Enables filtering based on severity, labels, alert source, or other
     * criteria. For example, a PagerDuty webhook might only send CRITICAL
     * alerts.
     *
