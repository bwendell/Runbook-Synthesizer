 ...
 * <ul>
 * <li>{@link com.oracle.runbook.output.WebhookDestination} - Interface for
 * webhook output channels</li>
 * <li>{@link com.oracle.runbook.output.WebhookResult} - Result record for
 * webhook responses</li>
 * </ul>
 */
