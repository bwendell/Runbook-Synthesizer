 ...
 * <p>
 * Fetches logs from OCI Logging Search API and converts them to domain model objects.
 * Uses the OCI Java SDK LogSearchClient for API calls.
 */
public class OciLoggingAdapter implements LogSourceAdapter {
    ...
    private Map<String, String> extractMetadata(Map<String, Object> data) {
        ...
        for (Map.Entry<String, Object> entry : data.entrySet()) {
            ...
            // Skip known fields
            if (!key.equals("logId") && !key.equals("datetime") && 
