 ...
 * <p>
 * This interface defines the contract for the context enrichment service in the
 * Hexagonal Architecture. Implementations orchestrate calls to
 * {@link MetricsSourceAdapter} and {@link LogSourceAdapter} to gather real-time
 * infrastructure state for a given alert.
 * <p>
 * All operations are async to parallelize external API calls and support
 * Helidon SE's reactive patterns.
 *
 * @see EnrichedContext
...
public interface ContextEnrichmentService {
	 ...
	 *
	 * @param alert
	 *            the alert to enrich with context
