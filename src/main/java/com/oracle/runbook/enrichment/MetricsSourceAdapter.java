 ...
 * with specific metrics backends like OCI Monitoring, Prometheus, etc.
 * <p>
...
public interface MetricsSourceAdapter {
     ...
     * <p>
     * The implementation should query the underlying metrics backend and return
     * all relevant metric snapshots for the resource within the time window.
     *
     * @param resourceId the identifier of the resource to fetch metrics for
     *                   (e.g., OCID for OCI, instance ID for Prometheus)
     * @param lookback   the time duration to look back from now
     * @return a CompletableFuture containing the list of metric snapshots,
