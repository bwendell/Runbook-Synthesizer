 ...
 * <p>
 * Fetches metrics from OCI Monitoring API and converts them to domain model objects.
 * Uses the OCI Java SDK MonitoringClient for API calls.
 */
public class OciMonitoringAdapter implements MetricsSourceAdapter {
    ...
    /**
     * Extracts the unit from MetricData metadata.
     * OCI stores unit in the metadata map with key "unit".
     */
