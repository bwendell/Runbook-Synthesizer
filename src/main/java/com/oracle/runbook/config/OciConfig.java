 ...
 *
 * <p>Holds the necessary configuration for connecting to OCI services, including the compartment
 * ID, region, config file path, and profile name.
 *
...
public record OciConfig(
    String compartmentId, String region, String configFilePath, String profile) {
