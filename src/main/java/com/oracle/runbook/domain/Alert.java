...
/**
 * Canonical alert model for normalized ingestion from multiple sources. Represents an alert from
 * OCI Monitoring Alarms, Events Service, or manual API submission.
 *
 * @param id the unique identifier for this alert
 * @param title the alert title/name
 * @param message the detailed alert message
 * @param severity the severity level of the alert
 * @param sourceService the originating service (e.g., "oci-monitoring", "oci-events")
 * @param dimensions key-value pairs from the alert source (e.g., compartmentId, resourceId)
