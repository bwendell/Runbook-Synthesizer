 ...
 * @param runbookPath
 *            path to the source runbook file
 * @param sectionTitle
 *            the title of this section
 * @param content
 *            the actual text content
 * @param tags
 *            semantic tags for filtering (e.g., memory, oom, linux)
 * @param applicableShapes
 *            compute shapes this applies to (e.g., VM.*, GPU.*)
 * @param embedding
 *            vector embedding for similarity search
 */
public record RunbookChunk(String id, String runbookPath, String sectionTitle, String content, List<String> tags,
		List<String> applicableShapes, float[] embedding) {
	/**
